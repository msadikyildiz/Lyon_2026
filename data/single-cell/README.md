...
The [EcoCyc enrichment record](enrichment/README.md) documents five original exports, their worksheet mappings, exact result checks, and the analyst-reported usual Fisher Exact/Benjamini–Hochberg settings with P < 0.1. EcoCyc 29.0 and default annotation-specific backgrounds are assumed from the May 2025 dates and reported standard workflow; the enrichment record distinguishes these assumptions from the supplied results. GSE314756 is scheduled for public release on 21 December 2026; no reviewer credential is stored here.
