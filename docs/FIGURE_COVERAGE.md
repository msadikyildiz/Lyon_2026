...
|---|---|---|
| 1 | Workbook values exported to Source Data | Schematics a–c supplied as PPTX; survival d–f workbooks supplied, original plotting/composition not in the command |
...
| 3 | IC50 b–d and MDK e; complete assembly | Survival a retained as image; workbook supplied |
...
| Supplementary 3 | IC50 b–d; complete assembly | Resistance a and genomic e retained as images; resistance workbook and complete displayed genomic table supplied |
| Supplementary 4 | IC50 b–d and MDK e; complete assembly | Survival a and genomic f retained as images; survival workbook supplied; genomic table has 50/83 rows |
