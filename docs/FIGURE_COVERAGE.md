...
The six original trajectory notebooks also render standalone panels to `out/trajectories`. These retain their original notebook styling; the reviewed assembled figures continue to use the established static trajectory panels.
