...
The default locked build produced 59 analytical PNGs and 20 assembly PNGs (ten final images plus previews) byte-identical to the reviewed reference. The raw-refit and clean-checkout outputs matched those images too. All 138,959 numeric Source Data cells matched the reference; text-only provenance paths were updated to the portable inputs.
